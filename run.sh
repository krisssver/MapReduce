...
-Dmapred.job.name='Homework 5' \
-file /tmp/mapreduce/mapper_lab5.py -mapper /tmp/mapreduce/mapper_lab5.py \
-file /tmp/mapreduce/reducer_lab5.py -reducer /tmp/mapreduce/reducer_lab5.py \
